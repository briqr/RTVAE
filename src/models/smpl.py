...
from src.config import SMPL_MODEL_PATH, SMPLX_MODEL_PATH, JOINT_REGRESSOR_TRAIN_EXTRA
...
class SMPLX(nn.Module):
    ...
    def __init__(self, model_path=SMPLX_MODEL_PATH, batch_size=1600, **kwargs):
        super(SMPLX, self).__init__(**kwargs)

        self.body_model = smplx.create(model_path, model_type='smplx',
    ...
    def forward(self, *args, **kwargs):
        smpl_output = self.body_model(*args, **kwargs)
