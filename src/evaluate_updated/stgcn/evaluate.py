...
class Evaluation:
    def __init__(self, dataname, parameters, device, seed=None):
        ...
        #modelpath = 'proxsingle_recognition_training/checkpoint_0200.pth.tar'
        #modelpath = 'proxrecurrent_recognition_training/checkpoint_0200.pth.tar'
        #modelpath = 'models/actionrecognition/humanact12_gru.tar'
        modelpath = 'recognition_training_prox_oneact_baseline/checkpoint_0100.pth.tar'
